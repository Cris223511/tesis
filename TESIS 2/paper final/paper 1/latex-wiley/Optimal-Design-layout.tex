...
\begin{document}
	...
	\corres{Jorge Eduardo Castañeda Alban (\email{jorge.castanedaa@usil.pe});
		Christopher Antonio Pillihuamán Santiago (\email{c.pillihuaman@usil.pe});
		Jhafet Martín Cánepa Maceda (\email{jhafet.canepa@usil.pe});
		Jomark Pablo Noriega Zapata (\email{jnoriegaz@usil.edu.pe});
		Juan Orlando Salazar Campos (\email{jsalazarc@usil.edu.pe});
		Kenny Disney Neira Neira (\email{kneira@usil.edu.pe})}
	\editor{}
	\presentaddress{}
	...
	\abstract[RESUMEN]{Los déficits en el reconocimiento emocional facial constituyen
		...
		34 estudios publicados entre 2018 y 2026 fueron incluidos. Las arquitecturas CNN
	...
	\transabstract[ABSTRACT]{Deficits in facial emotion recognition constitute a
		...
		Disorder (ASD). Following PRISMA 2020, 34 studies published between 2018 and 2026
	...
	en intervención temprana \cite{Washington2022}. Un hallazgo particularmente grave es que tres estudios fueron retractados entre diciembre 2024 y diciembre 2025 debido al uso de datasets de	Kaggle con imágenes de menores recopiladas de internet sin consentimiento parental documentado ni diagnóstico clínico verificado \cite{Gungor2025,Mahmood2025,Kumar2024}, exponiendo vulnerabilidades éticas fundamentales en la validación de tecnologías para TEA. Además, solo 8 de 34 estudios identificados ofrecen algún nivel de acceso a datos o código \cite{Sariyanidi2025,Hassan2025}, y ninguno comparte
	simultáneamente dataset completo y código fuente, revelando una crisis de reproducibilidad que obstaculiza el progreso científico acumulativo.
	...
	\begin{figure}[htb]
		\centerline{\includegraphics[width=\columnwidth]{fig_1.jpg}}
	...
	selección sino el marco estructural que determina qué estudios constituyen evidencia primaria para cada pregunta de investigación, qué estudios aportan
	...
	métricas de rendimiento (RQ3), se señalaron explícitamente las diferencias en las
	...
	entornos clínicos controlados \cite{Levy2024}. La proliferación de smartphones con chips de procesamiento neuronal dedicado y la maduración de frameworks como TensorFlow Lite y PyTorch Mobile sugieren que esta tendencia se intensificará en los próximos años \cite{Levy2024}.
	...
	persisten dificultades con los modelos implementados \cite{Radocaj2025}, que generalmente
	siguen paradigmas de caja negra con interpretabilidad clínica limitada \cite{Rhatassi2024}.
	Estos modelos presentan problemas particularmente en cuanto a la generalización con muestras
	pequeñas, el desbalance de clases, la multicolinealidad en datos multimodales y la traducción a
	...
	\begin{figure*}[htb]
		\centerline{\includegraphics[width=\linewidth]{fig_2.jpg}}
	...
	\begin{figure}[htb]
		\centerline{\includegraphics[width=\columnwidth]{fig_3.jpg}}
	...
	\begin{figure}[htb]
		\centerline{\includegraphics[width=\columnwidth]{fig_4.jpg}}
	...
	\begin{figure}[htb]
		\centerline{\includegraphics[width=\columnwidth]{fig_5.jpg}}
	...
	\begin{table*}[!t]
		...
		{\setlength{\tabcolsep}{4pt}
			\begin{tabular*}{\textwidth}{@{\extracolsep\fill}cllll@{\extracolsep\fill}}
				...
				2 & Precisión    & 6  & 46\% & \cite{Shaik2025,Cicceri2026,Hwang2024,Aljbori2025,Ramachandran2025,Hosney2024} \\
	...
	\begin{figure}[htb]
		\centerline{\includegraphics[width=\columnwidth]{fig_6.jpg}}
	...
	\begin{figure*}[htb]
		\centerline{\includegraphics[width=\linewidth]{fig_7.jpg}}
	...
	\begin{figure*}[htb]
		\centerline{\includegraphics[width=\linewidth]{fig_8.jpg}}
	...
	de la interacción terapéutica \cite{Cicceri2026,Rudovic2019}.
	...
	\begin{table}[!ht]
		...
		{\setlength{\tabcolsep}{3pt}
			\begin{tabular*}{\columnwidth}{@{\extracolsep\fill}clccl@{\extracolsep\fill}}
				...
				4 & Hold-out Validation               & 4  & 11.8\% & \cite{Shaik2025,Sariyanidi2025,Cicceri2026,Hwang2024} \\
	...
	típico superan a los casos TEA en proporciones que con frecuencia exceden 10:1 \cite{Shaik2025}.
	...
	\begin{figure*}[htb]
		\centerline{\includegraphics[width=\linewidth]{fig_9.jpg}}
	...
	emplean CNNs individuales \cite{Rudovic2019,Rhatassi2025}. Sin embargo, dado que
	...
	controlados (\cite{He2019,Reed2021,Radocaj2025,Washington2022,Sariyanidi2025,Hassan2025,Rudovic2018,Rudovic2019,Hwang2024,Papaioannou2021,Dapogny2019,Leo2018,Xu2023,OSullivan2023}).
	...
	Esta distribución de calidad incide directamente en la interpretación de
