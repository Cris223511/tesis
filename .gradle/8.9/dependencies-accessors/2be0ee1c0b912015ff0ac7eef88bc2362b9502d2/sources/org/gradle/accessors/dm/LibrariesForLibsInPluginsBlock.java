...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
        private final FirebaseAppdistributionLibraryAccessors laccForFirebaseAppdistributionLibraryAccessors = new FirebaseAppdistributionLibraryAccessors(owner);

        public FirebaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>firebase.appdistribution</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public FirebaseAppdistributionLibraryAccessors getAppdistribution() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForFirebaseAppdistributionLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class FirebaseAppdistributionLibraryAccessors extends SubDependencyFactory {

        public FirebaseAppdistributionLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>gradle</b> with <b>com.google.firebase:firebase-appdistribution-gradle</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getGradle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("firebase.appdistribution.gradle");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseAppdistributionGradle</b> with value <b>5.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
