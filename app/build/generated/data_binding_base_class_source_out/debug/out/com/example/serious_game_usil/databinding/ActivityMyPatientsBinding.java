...
public final class ActivityMyPatientsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMyPatientsBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout emptyStateLayout, @NonNull RecyclerView recyclerViewPatients,
  ...
  @NonNull
  public static ActivityMyPatientsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMyPatientsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_my_patients, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMyPatientsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMyPatientsBinding((LinearLayout) rootView, emptyStateLayout,
          recyclerViewPatients, searchView, swipeRefresh, toolbar, tvEmptyMessage, tvEmptyTitle);
    }
